...
/**
 * Class CreateFinanceTest.
 *
 * @group finance
 * @group api
 */
class CreateFinanceTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/finances';
    ...
    // TODO TEST
//    public function testCreateFinanceWithInvalidFields(): void
//    {
//        $data = [
...
//    public function testGivenHaveNoAccess_CannotCreateFinance(): void
//    {
